...
RSpec.describe AppointmentsController, type: :controller do
  ...
  let(:appointment_params_2){ {name: 'asdf', date_time: Time.zone.now + 2.days,email: 'sfsdf@fsd.com', phone_number: '6362988884', service_ids:service.id, store_id:staff.store_id} }

  let(:appointment_params_past){ {name: 'past', date_time: Time.zone.now - 2.days,email: 'sfsdf@fsd.com', phone_number: '6362988884', service_ids:service.id, store_id:staff.store_id} }

  let!(:appointment_invalid_params){ {name: 'Michael',date_time: Time.zone.now + 2.days, email: 'sfsdf@fsd.com', service_ids:service.id, store_id:staff.store_id} }
